---
title: 02_talos
description: Bootstrap Talos on the home node with topf.
---

# 02_talos

Bootstraps Talos Linux on the `home` node with the help of [topf](https://github.com/postfinance/topf). The authoritative files live in [kubernetes/bootstrap/home/2_talos](https://code.offene.cloud/homelab/kops/src/branch/main/kubernetes/bootstrap/home/2_talos).
...
Helpful VS Code extension: `@signageos/vscode-sops`.
...
See also [encryption](encryption/index.md) for the SOPS setup and key rotation.

## topf

Change into the directory `kubernetes/bootstrap/home/2_talos`.
